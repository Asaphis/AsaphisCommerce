...
MONGODB_URI=mongodb+srv://AsaPhis:OIprlNvZQBtnj9ar@cluster0.8i8wmya.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0
...
2. Select your service: `Product of Asaphis`
...
```
Webhook URL: https://Product of Asaphis.onrender.com/api/webhook/clerk
...
GET https://Product of Asaphis.onrender.com/api/webhook/clerk

# Test Inngest endpoint  
GET https://Product of Asaphis.onrender.com/api/inngest
```
...
**Production URL**: https://Product of Asaphis.onrender.com/
**Webhook URL**: https://Product of Asaphis.onrender.com/api/webhook/clerk
